...
Be careful: there are newer versions of cedet that will not work with
matlab-emacs yet. Cedet will be part of emacs-24, and therefore had
to change some file names. This is not corrected in matlab-emacs yet.
If you get some errors relating to something like semanticdb-search,
it could mean that your cedet version is already too new. Stable
version 1.1 did still work, current development head not.
